...
明确披露 AI 协作：ChatGPT 仅辅助语言编辑和表述；作者明确声明数学想法、论证和结论由作者负责。
...
明确披露 AI 协作：ChatGPT Pro 辅助定理 20 的证明，并用于简化证明、检查技术步骤、写作及查找参考文献。
...
明确披露 AI 协作：Claude 辅助编写制作部分插图的 Mathematica 代码；作者明确称文章没有 AI 生成的想法或文字。
...
明确披露 AI 协作：GPT-5.6 Pro 提出将 Chodosh–Vikman 结果用于本问题的关键观察，并生成相当部分初稿；作者检查修订。
...
明确披露 AI 协作：ChatGPT 参与证明策略的发展、检查与文字组织；作者承担最终责任。
...
明确披露 AI 协作：反例由 gpt-5.6-sol 辅助构造，作者随后仔细核验其数学正确性。
...
明确披露 AI 协作：ChatGPT 用于编辑、文献辅助与数学讨论；Claude 对定理 9.3 的构思起重要作用，作者独立核验。
...
明确披露 AI 协作：Codex GPT-5.6 Sol 辅助英文与 LaTeX 编辑、文章组织、证明表述讨论及计算初检；作者核验数学内容。
...
明确披露 AI 协作：作者提供方法框架，GPT-5.6 sol 辅助数值计算、证明、语言及 Lean 4 形式化。
