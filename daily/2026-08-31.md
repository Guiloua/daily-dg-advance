...
$$
x_0+rQ \subset K\subset y_0+RQ.
$$

 Writing $s=\text{vol}(S)/\text{vol}(K)$, we prove that whenever $0&lt;s \\le 1/2$, 

$$
\frac{\text{vol}(\partial_0^K S)}{\text{vol}(S)} \ge \frac{cr}{nR} \min\left\{1,\frac{\log(e/s)}{n}\right\},
$$
