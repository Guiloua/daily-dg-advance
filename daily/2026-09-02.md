...
In this paper, we study the asymptotic Plateau problem in hyperbolic space for hypersurfaces of constant $H_k$-curvature\. We prove the existence of a smooth complete $k$-convex hypersurface in $\mathbb{H}^{n+1}$ satisfying 

$$
H_k(κ)=σ, \qquad σ\in(0,1),
$$

 with prescribed asymptotic boundary at infinity\. In particular, our result extends the range of the constant $σ$ in the existence theorem of Guan and Spruck \[J\. Eur\. Math\. Soc\. 12 \(2010\), no\. 3, 797--817\] for $H_{k}$ curvature to the full interval $(0,1)$\.
...
We determine the Morse index and normal nullity of minimal immersions $S^2\to \mathbb{C}P^N$ with constant Gauss curvature\. For integers $n\ge1$ and $k\in\{0,\ldots,n\}$, the member $φ_{n-2k,n}:S^2 \to \mathbb{C}P^n$ of the Veronese sequence satisfies 

$$
\operatorname{Ind}(φ_{n-2k,n})=2k(n-k)(n+1),\qquad \operatorname{Nul}(φ_{n-2k,n})=2(n-1)(n+3).
$$

 We also obtain the corresponding formulas for its totally geodesic extensions to $\mathbb{C}P^N$, $N\ge n$, and identify the normal Jacobi kernel with infinitesimal deformations obtained by post-composing the rational normal directrix with projective linear embeddings into $\mathbb{C}P^N$\. In particular, every normal Jacobi field is integrable through a family of minimal $2$-spheres\.
