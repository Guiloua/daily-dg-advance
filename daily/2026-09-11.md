...
明确披露 AI 协作：声明 Claude 与 ChatGPT 用于稿件准备，作者负责最终内容。
...
明确披露 AI 协作：声明主结果通过使用 GPT 模型的 Rethlas agent 证明，作者随后简化并负责其正确性。
...
明确披露 AI 协作：ChatGPT 作为研究助手核查张量计算、数值恒等式并辅助起草润色。
...
明确披露 AI 协作：作者明确声明 ChatGPT 辅助论文发展，但文字由作者撰写。
...
明确披露 AI 协作：正文声明稳定算子的某个不等式及其使用由 ChatGPT 建议，另辅助语言与检查。
...
明确披露 AI 协作：作者声明使用 ChatGPT 作为研究辅助工具。
...
明确披露 AI 协作：ChatGPT 与 Claude 辅助文献、想法探索及符号计算。
...
明确披露 AI 协作：ChatGPT 与 Codex 辅助语言、表述及组织。
...
明确披露 AI 协作：ChatGPT 辅助组织、表述、校对及论证呈现反馈，作者声明计算证明由其完成。
...
明确披露 AI 协作：ChatGPT 辅助论证细节检查、表述和稿件准备；复数版本的模型贡献另列伴随论文。
...
明确披露 AI 协作：GPT-5.6 Sol 用于计算，GPT-6 Astra 用于语法和表述。
...
明确披露 AI 协作：ChatGPT 辅助将早期稿件整理成本文，附录 A 自动正则性论证主要通过与其讨论发展。
...
明确披露 AI 协作：作者声明结果获得 GPT-6 Astra 协助。
...
明确披露 AI 协作：声明 GPT-5.6 Sol 发展证明并生成初稿，随后由作者修改；自动 LLM 审阅不是形式化证明。
...
明确披露 AI 协作：ChatGPT 与 Claude 引导 Young 积分思路，并辅助若干证明策略、例子和文字。
...
明确披露 AI 协作：正文声明反例由 GPT-6 Astra 自主找到，基本提供相应证明并参与起草。
...
明确披露 AI 协作：ChatGPT 辅助语言编辑及部分计算检查。
...
明确披露 AI 协作：LLM 工具辅助部分文字准备、语言编辑和绘图。
...
明确披露 AI 协作：ChatGPT 与 Claude 辅助论证核查，ChatGPT 生成附录 SageMath 验证代码后由作者精确计算核验。
...
明确披露 AI 协作：AI 语言模型辅助检索、起草编辑及内部一致性检查代码。
...
明确披露 AI 协作：Gemini 辅助绘图，Claude 校对并指出早期稿件的不准确之处。
...
明确披露 AI 协作：ChatGPT 用于探索计算、文献检索和语言编辑。
...
明确披露 AI 协作：ChatGPT 辅助语言、结构、排版及符号一致性检查。
