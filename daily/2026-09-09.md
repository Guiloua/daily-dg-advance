...
明确披露 AI 协作：正文 AI disclosure 披露若干关键步骤由 AI 协助解决，作者写初稿并用 AI 改进措辞。
...
明确披露 AI 协作：AI use disclosure 披露生成式 AI 协助文献检索、理解引用、按作者策略搜索证明和补技术细节及语言编辑。
...
明确披露 AI 协作：英文摘要明确称其反例为 AI-generated construction。
...
明确披露 AI 协作：AI 工具声明披露 GPT 仅建议了相关平滑结果，文稿与数学论证由作者完成。
...
明确披露 AI 协作：作者评论及 AI usage 段披露 ChatGPT 生成主要定理和证明，作者参与构造方向的选择。
...
明确披露 AI 协作：正文披露与 ChatGPT 密切合作，涉及证明策略、论证、参考文献及文稿起草修订。
...
明确披露 AI 协作：第 6 节披露作者提出将 Kupka 反例端点化的思想，数学实现由 ChatGPT 生成，作者承担责任。
...
明确披露 AI 协作：正文披露曾用生成式 AI 发展稳定叶支撑论证，但该 AI 证明已被弃用并由作者自写的更短证明替代；仍属明确披露的研究流程辅助。
...
明确披露 AI 协作：作者评论与正文声明：主证明策略来自与 ChatGPT 的互动，作者随后发展并独立核验。
...
明确披露 AI 协作：正文 AI assistance 声明披露使用以 ChatGPT 为主的辅助工具，作者撰写并核验定理及证明。
...
明确披露 AI 协作：AI Disclosure 披露 OpenAI 语言模型参与发展和检查 Fourier 与非线性共振论证。
...
明确披露 AI 协作：摘要、评论及正文披露 GPT 生成证明主体并整理文稿，作者核查修订。
...
明确披露 AI 协作：正文披露 ChatGPT 用于探索性计算和编辑辅助。
...
明确披露 AI 协作：文稿准备声明披露 ChatGPT 用于探索证明策略和协助起草。
...
明确披露 AI 协作：正文披露 ChatGPT 用于探索性计算、可能证明方向及编辑润色。
...
明确披露 AI 协作：正文披露 GPT 协助证明严谨化、定位 Colesanti 等参考文献及语言润色。
...
明确披露 AI 协作：AI 声明披露 ChatGPT 辅助语言、论述以及计算和逻辑一致性检查。
...
明确披露 AI 协作：正文披露 ChatGPT 在作者框架下帮助发展证明技术，并参与变半径扩展；作者负责撰写组织和核验。
...
明确披露 AI 协作：AI-disclosure 披露 GPT 协助构思、探索证明策略和撰写证明，对第 2–4 节有实质影响，并修订多处文本。
...
明确披露 AI 协作：正文披露与 ChatGPT 讨论时得到关键局部曲率渐近式，作者随后核查发展。
...
明确披露 AI 协作：致谢披露 ChatGPT 参与文稿准备，作者审阅修订并承担责任。
...
明确披露 AI 协作：正文披露 ChatGPT 处理次要细节及语法问题，作者审阅所有修改。
...
明确披露 AI 协作：AI 声明披露通用大模型用于文献搜索、证明策略讨论和证明检查，同时明确未用 AI 撰写正文。
...
明确披露 AI 协作：致谢披露使用 ChatGPT 讨论证明策略、检查计算并协助准备文稿，作者承担核验责任。
...
明确披露 AI 协作：正文与致谢披露大模型反复帮助识别数学错误和排版错误；文稿主体在生成式 AI 广泛使用前已写成。
...
明确披露 AI 协作：正文披露 ChatGPT 用于检查论证和文献、编辑文本及准备 LaTeX。
...
明确披露 AI 协作：AI Disclosure 披露模型协助定位 Bass 结果，并为 genus 1 的代数命题给出初始证明，作者核验重写。
...
明确披露 AI 协作：正文披露 ChatGPT、Codex 用于探索性计算、证明方向及编辑润色，作者负责证明和计算。
...
明确披露 AI 协作：AI Declaration 披露模型指出相关已有例子，并参与计算、中间结果核验及写作润色。
...
明确披露 AI 协作：正文披露 ChatGPT 用于语言润色及结构组织，数学思想由作者提出。
...
明确披露 AI 协作：正文披露与 GPT 讨论 C1,1bar 估计但未得到作者所需证明，另用于表述和语法修订。
...
明确披露 AI 协作：正文披露 Claude、Grok 等用于构思、证明写作、文献搜索和查错。
...
明确披露 AI 协作：AI disclosure 披露 GPT 协助局部变形构造，建议附录中的同伦群同构和相关映射。
...
明确披露 AI 协作：AI 使用声明披露 GPT 协助数学表述、TikZ 绘图和英文写作。
...
明确披露 AI 协作：生成式 AI 声明披露 Claude 与 ChatGPT 辅助探索、结构组织、起草和文本修订。
...
明确披露 AI 协作：致谢披露 ChatGPT 仅用于英文润色和可读性改进。
...
明确披露 AI 协作：摘要及第 5 节披露 AI agents 在人类指导下设计运行实验、实现认证器并起草文稿。
...
明确披露 AI 协作：AI assistance 致谢披露 GPT 辅助论述、证明发展、精确计算和数值核验。
...
明确披露 AI 协作：正文披露 ChatGPT、Codex、Claude 和 Gemini 用于探索讨论、语言编辑、代码审查及书目核对。
...
明确披露 AI 协作：AI-use 声明披露 ChatGPT 与 Codex 用于检索、数学探索、符号数值检查及草稿修订。
...
明确披露 AI 协作：摘要及致谢披露 GPT、Claude 协助寻找反例、代数计算和尝试新猜想；作者明确完整猜想尚未证明。
...
明确披露 AI 协作：正文明确论文及求解器代码由作者撰写；Claude 用于求解器调试和 C++ 文档检索，因此属于已披露研究流程辅助。
