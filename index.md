...
核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。PDF 第 4 页致谢明确声明文章写作未使用 LLM；未发现正面的 AI 使用披露。该表述仅记录作者声明，不是对完全未使用 AI 的独立保证。

来源：https://arxiv.org/pdf/2609.20900v1
...
来源：https://arxiv.org/pdf/2609.20987v1
...
来源：https://arxiv.org/pdf/2609.21067v1
...
来源：https://arxiv.org/pdf/2609.21068v1
...
明确披露 AI 协作：作者披露使用 ChatGPT 进行探索性数学讨论、计算与表述检查、文献协助及语言编辑，并称最终数学陈述、证明和参考文献由作者独立核查。

来源：https://arxiv.org/pdf/2609.21101v1 · PDF 第 10 页 Declaration on the use of generative AI

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露使用 ChatGPT 进行探索性数学讨论、计算与表述检查、文献协助及语言编辑，并称最终数学陈述、证明和参考文献由作者独立核查。

来源：https://arxiv.org/pdf/2609.21101v1
...
明确披露 AI 协作：作者披露使用 LLM 进行英文翻译、语言编辑与 LaTeX 排版协助，并声明数学内容由作者发展。

来源：https://arxiv.org/pdf/2609.21266v1 · PDF 第 25 页 Use of AI tools

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露使用 LLM 进行英文翻译、语言编辑与 LaTeX 排版协助，并声明数学内容由作者发展。

来源：https://arxiv.org/pdf/2609.21266v1
...
明确披露 AI 协作：作者披露使用 Codex／GPT-5.6 Sol Ultra 扩展初始证明草稿、探索及完善证明策略、检查中间论证、检索文献和改善表述；作者称已大幅修改、重写并独立核验最终内容。

来源：https://arxiv.org/pdf/2609.21357v1 · PDF 第 16 页 Acknowledgements

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露使用 Codex／GPT-5.6 Sol Ultra 扩展初始证明草稿、探索及完善证明策略、检查中间论证、检索文献和改善表述；作者称已大幅修改、重写并独立核验最终内容。

来源：https://arxiv.org/pdf/2609.21357v1
...
明确披露 AI 协作：作者披露大量使用 ChatGPT 6.0，按作者指定方向生成低维反例原型，再经多轮交互加强；作者称已核验论证、补全细节并重组文章。

来源：https://arxiv.org/pdf/2609.21443v1 · PDF 第 4 页 AI usage

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露大量使用 ChatGPT 6.0，按作者指定方向生成低维反例原型，再经多轮交互加强；作者称已核验论证、补全细节并重组文章。

来源：https://arxiv.org/pdf/2609.21443v1
...
来源：https://arxiv.org/pdf/2609.21452v1
...
明确披露 AI 协作：作者披露在准备稿件时使用 GPT-5.6 和 GPT-6，并称已审核、修改数学内容；声明未细分具体用途。

来源：https://arxiv.org/pdf/2609.21469v1 · PDF 第 14 页 Acknowledgments

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露在准备稿件时使用 GPT-5.6 和 GPT-6，并称已审核、修改数学内容；声明未细分具体用途。

来源：https://arxiv.org/pdf/2609.21469v1
...
明确披露 AI 协作：作者声明写作与数学内容由作者完成；ChatGPT Pro 用于项目初期文献检索、发现记号不一致和小错误。

来源：https://arxiv.org/pdf/2609.21472v1 · PDF 第 4 页 AI Disclosure

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者声明写作与数学内容由作者完成；ChatGPT Pro 用于项目初期文献检索、发现记号不一致和小错误。

来源：https://arxiv.org/pdf/2609.21472v1
...
来源：https://arxiv.org/pdf/2609.21491v1
...
明确披露 AI 协作：作者披露使用 ChatGPT 起草和编辑、探索论证、核查计算与参考文献以及检索文献，并称已彻底检查文章。

来源：https://arxiv.org/pdf/2609.21510v1 · PDF 第 37 页 Use of AI tools

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露使用 ChatGPT 起草和编辑、探索论证、核查计算与参考文献以及检索文献，并称已彻底检查文章。

来源：https://arxiv.org/pdf/2609.21510v1
...
明确披露 AI 协作：作者披露初稿完成后仅用 AI 润色语言，并声明数学思想、论证和结果由作者独立发展。

来源：https://arxiv.org/pdf/2609.21518v1 · PDF 第 8 页 Development of the results and AI usage statement

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露初稿完成后仅用 AI 润色语言，并声明数学思想、论证和结果由作者独立发展。

来源：https://arxiv.org/pdf/2609.21518v1
...
来源：https://arxiv.org/pdf/2609.21528v1
...
明确披露 AI 协作：作者披露使用 ChatGPT 进行探索性计算、探索可能证明方向及文字润色，并称已审核核验输出；第 4 页 AI 是对称空间分类记号。

来源：https://arxiv.org/pdf/2609.21535v1 · PDF 第 26 页 Use of generative AI

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露使用 ChatGPT 进行探索性计算、探索可能证明方向及文字润色，并称已审核核验输出；第 4 页 AI 是对称空间分类记号。

来源：https://arxiv.org/pdf/2609.21535v1
...
明确披露 AI 协作：作者披露 ChatGPT 协助数学讨论、语言编辑、文献探索与证明检查，并称已独立核验其建议。

来源：https://arxiv.org/pdf/2609.21571v1 · PDF 第 42 页 Statement on the use of generative AI

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露 ChatGPT 协助数学讨论、语言编辑、文献探索与证明检查，并称已独立核验其建议。

来源：https://arxiv.org/pdf/2609.21571v1
...
明确披露 AI 协作：作者明确披露在论文发展过程中使用 AI 工具，未注明具体工具与用途。

来源：https://arxiv.org/pdf/2609.21670v1 · PDF 第 51 页 AI disclosure

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者明确披露在论文发展过程中使用 AI 工具，未注明具体工具与用途。

来源：https://arxiv.org/pdf/2609.21670v1
...
来源：https://arxiv.org/pdf/2609.21721v1
...
明确披露 AI 协作：第二作者披露 ChatGPT 协助探索导向不变四形式条件的延拓论证，以及组织、起草早期稿件；作者称已彻底核查和重写数学论证。

来源：https://arxiv.org/pdf/2609.21773v1 · PDF 第 2 页 Acknowledgements

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。第二作者披露 ChatGPT 协助探索导向不变四形式条件的延拓论证，以及组织、起草早期稿件；作者称已彻底核查和重写数学论证。

来源：https://arxiv.org/pdf/2609.21773v1
...
来源：https://arxiv.org/pdf/2609.21877v1
...
明确披露 AI 协作：作者披露 Astra-6 在作者提出研究方向后、较少协助下产生初始证明；作者随后检查和重写以突出数学思想、改善表述。

来源：https://arxiv.org/pdf/2609.21893v1 · PDF 第 1 页 AI usage statement

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露 Astra-6 在作者提出研究方向后、较少协助下产生初始证明；作者随后检查和重写以突出数学思想、改善表述。

来源：https://arxiv.org/pdf/2609.21893v1
...
明确披露 AI 协作：作者披露 LLM 协助将实现移植到 SageMath，Grammarly 与 Overleaf AI 检查语言；配套网站、目录生成脚本和文档由 Google Antigravity 与 Codex 生成。作者声明正文未由 LLM 生成，数学公式、算法选择和输出核验由作者负责。

来源：https://arxiv.org/pdf/2609.21914v1 · PDF 第 9–10 页 实现与 AI 使用说明

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露 LLM 协助将实现移植到 SageMath，Grammarly 与 Overleaf AI 检查语言；配套网站、目录生成脚本和文档由 Google Antigravity 与 Codex 生成。作者声明正文未由 LLM 生成，数学公式、算法选择和输出核验由作者负责。

来源：https://arxiv.org/pdf/2609.21914v1
...
明确披露 AI 协作：作者披露使用大语言模型协助初步文献检索。

来源：https://arxiv.org/pdf/2609.21931v1 · PDF 第 12 页 Acknowledgements

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露使用大语言模型协助初步文献检索。

来源：https://arxiv.org/pdf/2609.21931v1
...
明确披露 AI 协作：作者披露使用 Claude Code 和 Codex 进行探索讨论、思想检验与完善、文献组织、代码与 Lean 形式化开发验证、数学纠错及编辑修改。

来源：https://arxiv.org/pdf/2609.21950v1 · PDF 第 11 页 AI-use disclosure

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露使用 Claude Code 和 Codex 进行探索讨论、思想检验与完善、文献组织、代码与 Lean 形式化开发验证、数学纠错及编辑修改。

来源：https://arxiv.org/pdf/2609.21950v1
...
明确披露 AI 协作：作者披露 ChatGPT／GPT-5.6 Sol 参与发展引理 1.4 的证明、润色引理 5.3 的证明，并对数学内容负责。

来源：https://arxiv.org/pdf/2609.21952v1 · PDF 第 14 页 Acknowledgements

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露 ChatGPT／GPT-5.6 Sol 参与发展引理 1.4 的证明、润色引理 5.3 的证明，并对数学内容负责。

来源：https://arxiv.org/pdf/2609.21952v1
...
明确披露 AI 协作：作者披露高度依赖生成式 AI：Claude 与 OpenAI 模型经 Claude Code、Codex 和聊天界面，在作者引导下探索、发现几何化简、发展及 Lean 形式化证明、编程、计算实验和起草文章；作者称已审核核验输出。

来源：https://arxiv.org/pdf/2609.21968v1 · PDF 第 19 页 Acknowledgments

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露高度依赖生成式 AI：Claude 与 OpenAI 模型经 Claude Code、Codex 和聊天界面，在作者引导下探索、发现几何化简、发展及 Lean 形式化证明、编程、计算实验和起草文章；作者称已审核核验输出。

来源：https://arxiv.org/pdf/2609.21968v1
...
明确披露 AI 协作：作者明确披露使用 ChatGPT，并承担论文内容责任；未说明具体用途。

来源：https://arxiv.org/pdf/2609.22059v1 · PDF 第 9 页 Acknowledgment of AI assistance

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者明确披露使用 ChatGPT，并承担论文内容责任；未说明具体用途。

来源：https://arxiv.org/pdf/2609.22059v1
...
来源：https://arxiv.org/pdf/2609.22065v1
...
明确披露 AI 协作：作者披露定理 1.1、1.2、1.3 证明的主要思想来自 GPT-6 Astra；作者负责理解论证、简化数值工作、用 Lean 核验数值证书，并扩展计算机辅助证明的参数范围。

来源：https://arxiv.org/pdf/2609.22077v1 · PDF 第 4 页 Usage of Large Language Models

核查范围：对该版本全部可提取页面做 AI 披露关键词检索，并核对命中段落；这不是对整篇数学证明的审读。作者披露定理 1.1、1.2、1.3 证明的主要思想来自 GPT-6 Astra；作者负责理解论证、简化数值工作、用 Lean 核验数值证书，并扩展计算机辅助证明的参数范围。

来源：https://arxiv.org/pdf/2609.22077v1
